...
def tambah_data_admin():
    try:
        ...
        email_admin = input("Masukkan Email Admin: ")
        password_admin = input("Masukkan Password Admin: ")
        role = input("Masukkan Role Admin: ")
        query = f"""
...
def perbarui_data_admin():
    try:
        ...
        nama_admin = input("Masukkan Nama Admin Baru: ")
        email_admin = input("Masukkan Email Admin Baru: ")
        password_admin = input("Masukkan Password Admin Baru: ")
        role = input("Masukkan Role Admin Baru: ")
...
def tambah_data_perkotaan():
    try:
        ...
        while luas_wilayah is None:
            try:
                luas_wilayah = float(input("Masukkan Luas Wilayah: "))
            except ValueError:
                print("Luas wilayah harus berupa angka.")

        indeks_keberlanjutan_kota = int(input("Masukkan Indeks Keberlanjutan Kota: "))
        ...
        query_check_admin = "SELECT id_admin FROM admin WHERE id_admin = {}".format(id_admin)
...
def hapus_data_perkotaan():
    try:
        id_perkotaan = int(input("Masukkan ID Perkotaan yang ingin dihapus: "))
...
def perbarui_data_perkotaan():
    try:
        id_perkotaan = int(input("Masukkan ID Perkotaan yang ingin diperbarui: "))
        nama_kota = input("Masukkan Nama Kota Baru: ")
        provinsi = input("Masukkan Provinsi Baru: ")
        jumlah_penduduk = int(input("Masukkan Jumlah Penduduk Baru: "))
        ...
        indeks_keberlanjutan_kota = int(input("Masukkan Indeks Keberlanjutan Kota Baru: "))
        id_admin = int(input("Masukkan ID Admin: "))

        if jumlah_penduduk or luas_wilayah < 0:
            raise ValueError("Jumlah penduduk dan luas wilayah tidak boleh negatif")

        query_check_admin = "SELECT id_admin FROM admin WHERE id_admin = {id_admin}"
        mycursor.execute(query_check_admin)
        result_admin = mycursor.fetchone()
...
def tambah_data_pemukiman():
    try:
        nama_pemukiman = input("Masukkan Nama Pemukiman: ")
        id_perkotaan = int(input("Masukkan ID Perkotaan: "))
        jenis_pemukiman = input("Masukkan Jenis Pemukiman Formal/informal: ")
        akses_air_bersih = input("Masukkan Akses Air Bersih ya/tidak: ")
        akses_sanitasi_layak = input("Masukkan Akses Sanitasi Layak ya/tidak: ")
        id_admin = int(input("Masukkan ID Admin: "))

        query_check_perkotaan = "SELECT id_perkotaan FROM perkotaan WHERE id_perkotaan = {id_perkotaan}"
...
def hapus_data_pemukiman():
    try:
        id_pemukiman = int(input("Masukkan ID Pemukiman yang ingin dihapus: "))
...
def perbarui_data_pemukiman():
    try:
        id_pemukiman = int(input("Masukkan ID Pemukiman yang ingin diperbarui: "))
        nama_pemukiman = input("Masukkan Nama Pemukiman Baru: ")
        id_perkotaan = int(input("Masukkan ID Perkotaan Baru: "))
        jenis_pemukiman = input("Masukkan Jenis Pemukiman Baru: ")
        akses_air_bersih = input("Masukkan Akses Air Bersih Baru: ")
        akses_sanitasi_layak = input("Masukkan Akses Sanitasi Layak Baru: ")
        id_admin = int(input("Masukkan ID Admin: "))
        ...
        while True:
            ...
            if pilihan == "1":
                ...
                if result_index != -1:
                    print("Data ditemukan:")
                    x = PrettyTable()
                    x.field_names = ["ID", "Nama Proyek", "Tahun Mulai", "Tahun Selesai", "Lokasi", "ID ADMIN"]
                    x.add_row(data_list[result_index])
                    print(x)
                else:
                    print("Data tidak ditemukan.")
...
def tambah_data_proyek():
    try:
        ...
        id_pemukiman = int(input("Masukkan ID Pemukiman: "))
        deskripsi_proyek = input("Masukkan Deskripsi Proyek: ")
        jenis_proyek = input("Masukkan Jenis Proyek: ")
        dana_proyek = int(input("Masukkan Dana Proyek: "))
        status_proyek = input("Masukkan Status Proyek: ")
        id_admin = int(input("Masukkan ID Admin: "))
        if dana_proyek < 0:
            raise ValueError("Dana proyek tidak boleh negatif")

        query_check_pemukiman = "SELECT id_pemukiman FROM pemukiman WHERE id_pemukiman = {id_pemukiman}"
...
def hapus_data_proyek():
    try:
        id_proyek = int(input("Masukkan ID Proyek yang ingin dihapus: "))
...
def perbarui_data_proyek():
    try:
        id_proyek = int(input("Masukkan ID Proyek yang ingin diperbarui: "))
        nama_proyek = input("Masukkan Nama Proyek Baru: ")
        id_pemukiman = int(input("Masukkan ID Pemukiman Baru: "))
        deskripsi_proyek = input("Masukkan Deskripsi Proyek Baru: ")
        jenis_proyek = input("Masukkan Jenis Proyek Baru: ")
        dana_proyek = int(input("Masukkan Dana Proyek Baru: "))
        status_proyek = input("Masukkan Status Proyek Baru: ")
        id_admin = int(input("Masukkan ID Admin: "))
